...
// vytvorenie basic info pre neskorsie zobrazenie v gui
    public String getBasicInfo(ResourceBundle bundle) {
        ...
        String insuranceValue = insuranceNumber != null ? insuranceNumber : bundle.getString("not.set");
    ...
    public Patient(String name, LocalDate birthdate, String gender, String email, String phone,
                   String birthCity, String currentCity, String street, String postalCode,
                   String insuranceNumber, String bloodPressure, Double bmi,
