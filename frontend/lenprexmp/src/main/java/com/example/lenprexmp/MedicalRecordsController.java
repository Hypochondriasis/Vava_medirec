...
// Diagnostické záznamy
        p1.addRecord(new MedicalRecord("01.01.2023", "Kontrola krvného tlaku", "Prestarium, Magnézium", "Záznam OK"));
        p1.addRecord(new MedicalRecord("15.02.2023", "EKG vyšetrenie", "Bez liekov", "Záznam OK"));
...
// Pridanie do fake databázy
    ...
    public void addRecord(String datum, String typ, String lieky,String diagnosis) {
        if (currentPatient != null) {
            MedicalRecord record = new MedicalRecord(datum, typ, lieky,diagnosis);
    ...
    private void renderRecordOnTop(MedicalRecord r) {
        ...
        ResourceBundle bundle = ResourceBundle.getBundle("messages", AppSettings.getLocale());
        Label dateLabel = new Label(bundle.getString("exam.date.label") + ": " + r.getDate());
    ...
    private void onAddRecordClicked() {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("newRecord.fxml"), bundle);
    ...
    private void onShowPatientCardClicked() {
        ...
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("patientCart.fxml"), bundle);
