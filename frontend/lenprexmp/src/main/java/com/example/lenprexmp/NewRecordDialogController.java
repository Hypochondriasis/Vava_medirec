...
public class NewRecordDialogController {
    ...
    @FXML private TextField examTypeField;
    @FXML private VBox medsContainer;
    @FXML private VBox diagnosisContainer;
// tu treba nahrat choroby a lieky
    private final ObservableList<String> availableMeds = FXCollections.observableArrayList(
            "Paracetamol", "Ibuprofen", "Amoxicillin", "Aspirin", "Metformin"
    );

    private final ObservableList<String> availableDiagnoses = FXCollections.observableArrayList(
            "Hypertenzia", "Diabetes", "Astma", "Covid-19", "Chrípka"
    );
