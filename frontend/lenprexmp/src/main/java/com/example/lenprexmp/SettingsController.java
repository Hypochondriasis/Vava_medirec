    ...
    private void handleAddUser() {
        ...
        if (role.equals(bundle.getString("role.doctor"))) {
            if (specialization == null || specialization.trim().isEmpty()) {
                errors.append("- ").append(bundle.getString("validation.specialization")).append("\n");
            }
            if (doctorCode == null || doctorCode.trim().isEmpty()) {
                errors.append("- ").append(bundle.getString("validation.doctorcode")).append("\n");
            }
        }

        if (role.equals(bundle.getString("role.nurse"))) {
            if (assignedDoctor == null || assignedDoctor.trim().isEmpty()) {
                errors.append("- ").append(bundle.getString("validation.assigneddoctor")).append("\n");
            } else if (!doctorNames.contains(assignedDoctor)) {
                errors.append("- ").append(bundle.getString("validation.invaliddoctor")).append("\n");
            }
        }
