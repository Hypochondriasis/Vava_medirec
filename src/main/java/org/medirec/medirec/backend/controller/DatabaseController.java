...
public class DatabaseController {
	...
	public static List<Appointment> getAllAppointments() throws Exception {
		...
		return getAllAppointmentsInGroup(
			"doctor_id",
                Math.toIntExact(prihlaseny.getDoctor_id())
		);
	}
	...
	public static List<Appointment> getMultipleAppointments(List<Integer> ids)
		throws Exception {
		return DatabaseService.getMultiple(Appointment.class, ids);
	}

	public static Appointment saveOrUpdateAppointment(Appointment appointment)
		throws Exception {
	...
	public static List<Appointment> getAllAppointmentsInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
			Appointment.class,
			foreignKeyColumn,
			foreignKeyId
		);
	...
	// ===== AppointmentStatus =====
	public static List<AppointmentStatus> getAllAppointmentStatuses()
		throws Exception {
		return DatabaseService.getAll(AppointmentStatus.class);
	}

	public static AppointmentStatus getAppointmentStatusById(int id)
		throws Exception {
		return DatabaseService.getOne(AppointmentStatus.class, id);
	}

	public static List<AppointmentStatus> getMultipleAppointmentStatuses(
		List<Integer> ids
	) throws Exception {
		return DatabaseService.getMultiple(AppointmentStatus.class, ids);
	}

	public static AppointmentStatus saveOrUpdateAppointmentStatus(
	...
	public static List<AppointmentStatus> getAllAppointmentStatusesInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	public static List<Diagnosis> getMultipleDiagnoses(List<Integer> ids)
		throws Exception {
		return DatabaseService.getMultiple(Diagnosis.class, ids);
	}

	public static Diagnosis saveOrUpdateDiagnosis(Diagnosis diagnosis)
		throws Exception {
	...
	public static List<Diagnosis> getAllDiagnosesInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	public static List<DiagnosisType> getMultipleDiagnosisTypes(
		List<Integer> ids
	) throws Exception {
		return DatabaseService.getMultiple(DiagnosisType.class, ids);
	}

	public static DiagnosisType saveOrUpdateDiagnosisType(DiagnosisType type)
		throws Exception {
	...
	public static List<DiagnosisType> getAllDiagnosisTypesInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	public static List<Doctor> getMultipleDoctors(List<Integer> ids)
		throws Exception {
	...
	public static List<Doctor> getAllDoctorsInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	public static List<MedicalRecord> getAllMedicalRecords() throws Exception {
		User prihlaseny = getUserById(JwtUtil.getUserFromToken().getId());
		return getAllMedicalRecordsInGroup(
			"doctor_id",
                Math.toIntExact(prihlaseny.getDoctor_id())
		);
	}
	...
	public static List<MedicalRecord> getMultipleMedicalRecords(
		List<Integer> ids
	) throws Exception {
		return DatabaseService.getMultiple(MedicalRecord.class, ids);
	}

	public static MedicalRecord saveOrUpdateMedicalRecord(MedicalRecord record)
		throws Exception {
	...
	public static List<MedicalRecord> getAllMedicalRecordsInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	public static List<Medication> getMultipleMedications(List<Integer> ids)
		throws Exception {
		return DatabaseService.getMultiple(Medication.class, ids);
	}

	public static Medication saveOrUpdateMedication(Medication medication)
		throws Exception {
	...
	public static List<Medication> getAllMedicationsInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	public static List<Patient> getAllPatients() throws Exception {
		User prihlaseny = getUserById(JwtUtil.getUserFromToken().getId());
		return getAllPatientsInGroup("doctor_id", Math.toIntExact(prihlaseny.getDoctor_id()));
	}
	...
	public static List<Patient> getMultiplePatients(List<Integer> ids)
		throws Exception {
		return DatabaseService.getMultiple(Patient.class, ids);
	}

	public static Patient saveOrUpdatePatient(Patient patient)
		throws Exception {
	...
	public static List<Patient> getAllPatientsInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	public static List<Prescription> getMultiplePrescriptions(
		List<Integer> ids
	) throws Exception {
		return DatabaseService.getMultiple(Prescription.class, ids);
	}

	public static Prescription saveOrUpdatePrescription(
	...
	public static List<Prescription> getAllPrescriptionsInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	// ===== RecordDiagnosis =====
	public static List<RecordDiagnosis> getAllRecordDiagnoses()
		throws Exception {
		return DatabaseService.getAll(RecordDiagnosis.class);
	}

	public static RecordDiagnosis getRecordDiagnosisById(int id)
		throws Exception {
		return DatabaseService.getOne(RecordDiagnosis.class, id);
	}

	public static List<RecordDiagnosis> getMultipleRecordDiagnoses(
		List<Integer> ids
	) throws Exception {
		return DatabaseService.getMultiple(RecordDiagnosis.class, ids);
	}

	public static RecordDiagnosis saveOrUpdateRecordDiagnosis(
		RecordDiagnosis rd
	) throws Exception {
	...
	public static List<RecordDiagnosis> getAllRecordDiagnosesInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	public static List<Role> getMultipleRoles(List<Integer> ids)
		throws Exception {
	...
	public static List<Role> getAllRolesInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	public static List<Token> getMultipleTokens(List<Integer> ids)
		throws Exception {
	...
	public static List<Token> getAllTokensInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
	...
	public static List<User> getAllUsers() throws Exception {
		User prihlaseny = getUserById(JwtUtil.getUserFromToken().getId());
		return getAllUsersInGroup("doctor_id", Math.toIntExact(prihlaseny.getDoctor_id()));
	}
	...
	public static List<User> getMultipleUsers(List<Integer> ids)
		throws Exception {
	...
	public static List<User> getAllUsersInGroup(
		String foreignKeyColumn,
		int foreignKeyId
	) throws Exception {
		return DatabaseService.getAllInGroup(
