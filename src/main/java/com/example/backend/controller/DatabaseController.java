...
public class DatabaseController {
    ...
    public static List<com.example.backend.model.Patient> getAllPatientsInGroup(String foreignKeyColumn, int foreignKeyId) throws Exception {
    ...
    // ===== Point =====
    public static List<Point> getAllPoints() throws Exception {
        return DatabaseService.getAll(Point.class);
    }

    public static Point getPointById(int id) throws Exception {
        return DatabaseService.getOne(Point.class, id);
    }

    public static List<Point> getMultiplePoints(List<Integer> ids) throws Exception {
        return DatabaseService.getMultiple(Point.class, ids);
    }

    public static Point saveOrUpdatePoint(Point point) throws Exception {
        return DatabaseService.createOrUpdate(point);
    }

    public static void deletePoint(int id) throws Exception {
        DatabaseService.delete(Point.class, id);
    }

    public static List<Point> getAllPointsInGroup(String foreignKeyColumn, int foreignKeyId) throws Exception {
        return DatabaseService.getAllInGroup(Point.class, foreignKeyColumn, foreignKeyId);
    }

    // ===== RecordPoint =====
    public static List<RecordPoint> getAllRecordPoints() throws Exception {
        return DatabaseService.getAll(RecordPoint.class);
    }

    public static RecordPoint getRecordPointById(int id) throws Exception {
        return DatabaseService.getOne(RecordPoint.class, id);
    }

    public static List<RecordPoint> getMultipleRecordPoints(List<Integer> ids) throws Exception {
        return DatabaseService.getMultiple(RecordPoint.class, ids);
    }

    public static RecordPoint saveOrUpdateRecordPoint(RecordPoint recordPoint) throws Exception {
        return DatabaseService.createOrUpdate(recordPoint);
    }

    public static void deleteRecordPoint(int id) throws Exception {
        DatabaseService.delete(RecordPoint.class, id);
    }

    public static List<RecordPoint> getAllRecordPointsInGroup(String foreignKeyColumn, int foreignKeyId) throws Exception {
        return DatabaseService.getAllInGroup(RecordPoint.class, foreignKeyColumn, foreignKeyId);
    }
