...
// v podstate login controller
    ...
    private void handleLogin(ActionEvent event) throws IOException {
        ...
        LoginRequest vstup = new LoginRequest();
        vstup.setMail(usernameField.getText());
        vstup.setPassword(passwordField.getText());
        LoginResponse odpoved = AuthController.login(vstup);
