...
public class PatientCartController {
    ...
    @FXML private TextField nextVisitField;
    ...
    @FXML private TextField newAllergyField;
    @FXML private ListView<String> allergyListView;
    @FXML private Button addAllergyButton;
    ...
    public void initPatient(Patient patient) {
        ...
        System.out.println("initPatient called for: " + patient.getFirst_name());
        System.out.println("Setting birth date to: " + formatDate(patient.getBirth_date()));
        birthDateField.setText(formatDate(patient.getBirth_date()));
        ...
        bmiField.setText(patient.getBMI() != null ? String.format("%.2f", patient.getBMI()) : "");
        weightField.setText(patient.getWeight() != null ? String.format("%.1f", patient.getWeight()) : "");
        heightField.setText(patient.getHeight() != null ? String.format("%.1f", patient.getHeight()) : "");
    ...
    private void handleAllergyDoubleClick(MouseEvent event) {
        if (event.getClickCount() == 2) {
            String selected = allergyListView.getSelectionModel().getSelectedItem();
            if (selected != null) {
